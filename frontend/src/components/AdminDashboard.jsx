    ...
    <div className="flex h-screen w-screen bg-gray-100">
      ...
      <div className={`${sidebarOpen ? 'w-64' : 'w-20'} bg-indigo-700 text-white transition-all duration-300 ease-in-out`}>
        ...
        <nav className="mt-5">
          ...
          <div
            className="px-4 py-3 flex items-center gap-3 text-indigo-200 rounded-lg hover:bg-red-300 cursor-pointer hover:text-black"
            onClick={() => setActiveMenu('addHeroImages')}
          >
            <HelpCircle size={20} />
            {sidebarOpen && <span>AddHeroImages</span>}
          </div>

          {/*<div
            className="px-4 py-3 flex items-center gap-3 text-indigo-200 rounded-lg hover:bg-red-300 cursor-pointer hover:text-black"
            onClick={() => setActiveMenu('showHeroImages')}
          >
            <HelpCircle size={20} />
            {sidebarOpen && <span>ShowHeroImages</span>}
          </div>*/}
      ...
      <div className="flex-1 overflow-x-hidden overflow-y-auto">
        ...
        <div className="p-6">
          ...
          {activeMenu ===  'addHeroImages' && <><HeroImageUploadForm /> <HeroImageTable /></>}
